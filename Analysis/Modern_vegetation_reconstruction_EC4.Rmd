...
```{r}
#   Modify path to the data
pnv_path <- "/Users/Esmesaurio/OneDrive - University of Reading/NEW_ITERATION_FINAL_MAY_CORECTED_2021/New_iteration_solving_downcores/Data/Extract_PNV_biome/"
...
#Set proportion of the data to be used as training dataset
SampFrac <- 0.7
...
Downsampling any majority class to have the same number than GRAM
```{r}
